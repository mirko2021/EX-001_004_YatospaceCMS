...
<html>
	<head>
		...
		<link rel='stylesheet' type='text/css' href='${pageContext.request.contextPath}/universal/index-dl.css'></link>
		...
		<script type='text/javascript' src='${pageContext.request.contextPath}/SESSIONS/sessions-page.js'></script>
		<script type='text/javascript' src='${pageContext.request.contextPath}/SESSIONS/sessions-form-executor.js'></script>
	</head>
	<body>
		<script>
